#!/usr/bin/env python3
"""Workbench command line. Python 3.11+. Core has no third-party dependencies."""
...
def main():
    p=argparse.ArgumentParser(description='Jev + Codex decision workbench. Offline by default.')
