        ...
        try:
            if method=='initialize':
                ...
                instructions=(
                    ...
                    'Use jev_catalog and jev_describe before evaluation. Custom live state requires '
                    'an exact workspace/revision/request-bound human grant and sends minimized text '
                    'to the human-selected Jev provider. No judgment authorizes a shell command, '
